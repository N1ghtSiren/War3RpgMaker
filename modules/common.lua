...
---@class  pathingaitype:handle 
---@class  collisiontype:handle 
...
function ConvertPathingAIType(i) end	-- (native)


---@param i integer
---@return collisiontype
function ConvertCollisionType(i) end	-- (native)
...
EVENT_PLAYER_UNIT_DECAY_FINISHED = ConvertPlayerUnitEvent(319)	---@type playerunitevent	
-- ===================================================
...
EVENT_UNIT_DECAY_FINISHED = ConvertUnitEvent(318)	---@type unitevent	
-- ===================================================
...
ORIGIN_FRAME_INVENTORY_COVER_FRAME = ConvertOriginFrameType(45)	---@type originframetype	
ORIGIN_FRAME_UNIT_TIP = ConvertOriginFrameType(46)	---@type originframetype	
...
FRAMEEVENT_CHECKBOX_CHANGED = ConvertFrameEventType(17)	---@type frameeventtype	
FRAMEEVENT_CONTROL_RELEASE = ConvertFrameEventType(18)	---@type frameeventtype	
FRAMEEVENT_CONTROL_DRAG = ConvertFrameEventType(19)	---@type frameeventtype	
-- ===================================================
--  OS Key constants
-- ===================================================
...
UNIT_IF_COLLISION_TYPE = ConvertUnitIntegerField(FourCC('ucot'))	---@type unitintegerfield	
UNIT_IF_PATHING_AI = ConvertUnitIntegerField(FourCC('upai'))	---@type unitintegerfield	
UNIT_IF_PATHING_TYPE = ConvertUnitIntegerField(FourCC('upat'))	---@type unitintegerfield	
...
--  Pathing AI Type
PATHING_AI_TYPE_FOOT = ConvertPathingAIType(0)	---@type pathingaitype	
PATHING_AI_TYPE_AMPHIBIOUS = ConvertPathingAIType(64)	---@type pathingaitype	
PATHING_AI_TYPE_FLOAT = ConvertPathingAIType(128)	---@type pathingaitype	
PATHING_AI_TYPE_FLY = ConvertPathingAIType(192)	---@type pathingaitype	--  MOVE_TYPE_AMPHIBIOUS | MOVE_TYPE_FLOAT
--  Collision Type
COLLISION_TYPE_NONE = ConvertCollisionType(0)	---@type collisiontype	
COLLISION_TYPE_ANY = ConvertCollisionType(1)	---@type collisiontype	
COLLISION_TYPE_FOOT = ConvertCollisionType(2)	---@type collisiontype	
COLLISION_TYPE_AIR = ConvertCollisionType(4)	---@type collisiontype	
COLLISION_TYPE_BUILDING = ConvertCollisionType(8)	---@type collisiontype	
COLLISION_TYPE_HARVESTER = ConvertCollisionType(16)	---@type collisiontype	
COLLISION_TYPE_BLIGHTED = ConvertCollisionType(32)	---@type collisiontype	
COLLISION_TYPE_FLOAT = ConvertCollisionType(64)	---@type collisiontype	
COLLISION_TYPE_AMPHIBIOUS = ConvertCollisionType(128)	---@type collisiontype	
COLLISION_TYPE_GROUND = ConvertCollisionType(202)	---@type collisiontype	--  COLLISION_TYPE_FOOT | COLLISION_TYPE_BUILDING | COLLISION_TYPE_FLOAT | COLLISION_TYPE_AMPHIBIOUS
--  Target Flag
...
---@param offset real
---@return nothing
function TriggerWaitForSound(whichSound, offset) end	-- (native)
...
---@return integer
function BitwiseGetBit(i, bitIndex) end	-- (native)
...
---@return integer
function BitwiseSetBit(i, bitIndex, bitValue) end	-- (native)
...
---@return integer
function BitwiseGetByte(i, byteIndex) end	-- (native)
...
---@return integer
function BitwiseSetByte(i, byteIndex, byteValue) end	-- (native)
...
---@return integer
function BitwiseShiftLeft(i, bitsToShift) end	-- (native)


---@param i integer
---@param bitsToShift integer
---@return integer
function BitwiseShiftRight(i, bitsToShift) end	-- (native)
...
---@param byte4 integer
---@return integer
function BitwiseToInteger(byte1, byte2, byte3, byte4) end	-- (native)
...
---@param i integer
---@return string
function IntToChar(i) end	-- (native)
...
---@param max real
---@return real
function MathRealClamp(value, min, max) end	-- (native)
...
---@param t real
---@return real
function MathRealLerp(a, b, t) end	-- (native)
...
---@param max integer
---@return integer
function MathIntegerClamp(value, min, max) end	-- (native)
...
---@param flag boolean
---@return nothing
function ConsoleEnable(flag) end	-- (native)


---@param s string
---@return nothing
function ConsolePrint(s) end	-- (native)
--  
--  Text File API

---@param filePath string
---@return textfilehandle
function TextFileOpen(filePath) end	-- (native)


---@param filePath string
---@return boolean
function TextFileExists(filePath) end	-- (native)


---@param whichTextFile textfilehandle
---@return string
function TextFileGetPath(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@return nothing
function TextFileClose(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@return nothing
function TextFileClear(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@return nothing
function TextFileDelete(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@return integer
function TextFileCountLines(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@param lineNumber integer
---@return string
function TextFileReadLine(whichTextFile, lineNumber) end	-- (native)


---@param whichTextFile textfilehandle
---@return string
function TextFileReadAll(whichTextFile) end	-- (native)


---@param whichTextFile textfilehandle
---@param text string
---@return nothing
function TextFileWriteLine(whichTextFile, text) end	-- (native)
--  
--  Misc API
---@return string
...
---@param whichSound sound
---@return nothing
function RemoveSound(whichSound) end	-- (native)
...
---@param eaxSetting string
---@return sound
function ReplaceSound(whichSound, fileName, looping, is3D, stopwhenoutofrange, fadeInRate, fadeOutRate, eaxSetting) end	-- (native)
...
---@param SLKEntryName string
---@return sound
function ReplaceSoundWithLabel(whichSound, fileName, looping, is3D, stopwhenoutofrange, fadeInRate, fadeOutRate, SLKEntryName) end	-- (native)
...
---@param fadeOutRate integer
---@return sound
function ReplaceSoundFromLabel(whichSound, soundLabel, looping, is3D, stopwhenoutofrange, fadeInRate, fadeOutRate) end	-- (native)
...
---@param fadeOutRate integer
---@return sound
function ReplaceMIDISound(whichSound, soundLabel, fadeInRate, fadeOutRate) end	-- (native)
--  
--  Time API
...
---@return string
function GetTimeStamp(isLocalTime, isMiliseconds) end	-- (native)
--  
--  Screen/Window API
...
--  Cursor API
---@return boolean
function IsCursorEnabled() end	-- (native)


---@param enable boolean
---@return nothing
function SetCursorEnabled(enable) end	-- (native)

---@return boolean
function IsCursorAnimationLocked() end	-- (native)


---@param isLock boolean
---@return nothing
function SetCursorAnimationLocked(isLock) end	-- (native)
--  
--  Mouse API
---@return real
...
---@param filter boolexpr
---@return nothing
function HandleListEnumByTypeId(whichHandleList, handleTypeId, filter) end	-- (native)
...
---@param c code
---@return nothing
function HandleListForEachByTypeId(whichHandleList, handleTypeId, c) end	-- (native)
...
---@param target widget
---@return boolean
function IsAbilityBaseTargetAllowed(abilityId, source, target) end	-- (native)
--  source can be null
--  Normal API
...
-- 
---@return boolean
function IsWidgetTipEnabled() end	-- (native)
--  Internally this is called CUnitTip, but used for all widgets.

---@param enable boolean
---@return nothing
function SetWidgetTipEnabled(enable) end	-- (native)
...
---@return boolean
function IsWidgetTargetAllowed(whichWidget, target, whichFlags) end	-- (native)
...
---@param whichUnit unit
---@return collisiontype
function GetUnitCollisionType(whichUnit) end	-- (native)


---@param whichUnit unit
---@param collisionType collisiontype
---@return nothing
function SetUnitCollisionType(whichUnit, collisionType) end	-- (native)


---@param whichUnit unit
---@return pathingaitype
function GetUnitPathingAIType(whichUnit) end	-- (native)


---@param whichUnit unit
---@param pathingAIType pathingaitype
---@return nothing
function SetUnitPathingAIType(whichUnit, pathingAIType) end	-- (native)


---@param whichUnit unit
---@return pathingtype
function GetUnitPathingType(whichUnit) end	-- (native)


---@param whichUnit unit
---@param pathingType pathingtype
---@return nothing
function SetUnitPathingType(whichUnit, pathingType) end	-- (native)
...
---@param whichFrame framehandle
---@return string
function GetFrameModel(whichFrame) end	-- (native)
...
---@param whichFrame framehandle
---@return boolean
function IsFrameDraggable(whichFrame) end	-- (native)


---@param whichFrame framehandle
---@param enabled boolean
---@return nothing
function SetFrameDraggable(whichFrame, enabled) end	-- (native)


---@param whichFrame framehandle
---@return integer
function GetFrameTrackState(whichFrame) end	-- (native)


---@param whichFrame framehandle
---@param trackState integer
---@return nothing
function SetFrameTrackState(whichFrame, trackState) end	-- (native)
--  0 - NONE | 1 - Track | 2 - Ignore Track
...
---@return string
function GetFrameTexture(whichFrame, textureId) end	-- (native)
...
---@param blend boolean
---@return nothing
function SetFrameTextureEx(whichFrame, backgroundTextureFile, borderTextureFile, textureId, blend) end	-- (native)
...
---@param blend boolean
---@return nothing
function SetFrameTexture(whichFrame, textureFile, textureId, blend) end	-- (native)
...
---@param width real
---@return nothing
function SetFrameWidth(whichFrame, width) end	-- (native)
...
---@param height real
---@return nothing
function SetFrameHeight(whichFrame, height) end	-- (native)
...
---@param verticalAlign textaligntype
---@return nothing
function SetFrameTextVerticalAlignment(whichFrame, verticalAlign) end	-- (native)


---@param whichFrame framehandle
---@param horizontalAlign textaligntype
---@return nothing
function SetFrameTextHorizontalAlignment(whichFrame, horizontalAlign) end	-- (native)
...
---@param sizeZ real
---@return nothing
function SetFrameSpriteMaterialScale(whichFrame, sizeX, sizeY, sizeZ) end	-- (native)
